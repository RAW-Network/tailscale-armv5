...
docker buildx build \
  ...
  --platform $PLATFORM \
  --builder armv5-builder \
  --load -t ghcr.io/raw-network/tailscale-armv5:$VERSION .

skopeo copy docker-daemon:ghcr.io/raw-network/tailscale-armv5:$VERSION docker-archive:tailscale.tar
